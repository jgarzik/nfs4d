...
xdr_authsys_parms (XDR *xdrs, authsys_parms *objp)
{
	 ...
	 if (!xdr_u_quad_t (xdrs, &objp->aup_time))
		 return FALSE;
	 if (!xdr_string (xdrs, &objp->aup_machname, 255))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->aup_uid))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->aup_gid))
		 return FALSE;
	 if (!xdr_u_int (xdrs, &objp->aup_len))
		 return FALSE;
	 if (!xdr_array (xdrs, (char **)&objp->aup_gids, (u_int *) &objp->aup_len, 16,
...
bool_t
xdr_fattr4_fs_layout_type (XDR *xdrs, fattr4_fs_layout_type *objp)
{

	 if (!xdr_array (xdrs, (char **)&objp->fattr4_fs_layout_type_val, (u_int *) &objp->fattr4_fs_layout_type_len, ~0,
...
bool_t
xdr_fattr4_layout_type (XDR *xdrs, fattr4_layout_type *objp)
{

	 if (!xdr_array (xdrs, (char **)&objp->fattr4_layout_type_val, (u_int *) &objp->fattr4_layout_type_len, ~0,
		sizeof (layouttype4), (xdrproc_t) xdr_layouttype4))
		 return FALSE;
	return TRUE;
}
...
xdr_nfs_cb_argop4 (XDR *xdrs, nfs_cb_argop4 *objp)
{
	 ...
	 if (!xdr_nfs_cb_opnum4 (xdrs, &objp->argop))
		 return FALSE;
	switch (objp->argop) {
	case OP_CB_GETATTR:
...
xdr_nfs_cb_resop4 (XDR *xdrs, nfs_cb_resop4 *objp)
{
	 ...
	 if (!xdr_nfs_cb_opnum4 (xdrs, &objp->resop))
		 return FALSE;
	switch (objp->resop) {
	case OP_CB_GETATTR:
