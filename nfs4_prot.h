...
typedef struct {
	u_int fattr4_fs_layout_type_len;
	layouttype4 *fattr4_fs_layout_type_val;
...
typedef struct {
	u_int fattr4_layout_type_len;
	layouttype4 *fattr4_layout_type_val;
} fattr4_layout_type;
...
extern  bool_t xdr_fattr4_fs_layout_type (XDR *, fattr4_fs_layout_type*);
...
extern  bool_t xdr_fattr4_layout_type (XDR *, fattr4_layout_type*);
...
extern bool_t xdr_fattr4_fs_layout_type ();
...
extern bool_t xdr_fattr4_layout_type ();
